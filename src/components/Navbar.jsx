          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div className="relative flex items-center">
              ...
              <button
                ...
                className={`absolute right-0 w-9 h-9 flex items-center justify-center rounded-full transition-all ${isSearchOpen ? 'text-rose-brand hover:scale-110' : 'bg-transparent text-charcoal hover:bg-rose-50 hover:text-rose-brand'}`}
                aria-label="Search"
              >
            ...
            {(MOBILE_NAV_STYLE === 3 || MOBILE_NAV_STYLE === 4) && (
              <button
                className="md:hidden w-10 h-10 flex flex-col items-center justify-center rounded-lg bg-white/50 backdrop-blur-sm shadow-sm transition-transform active:scale-95 gap-1.5 ml-1"
            ...
            {MOBILE_NAV_STYLE === 5 && (
              <button
                className="md:hidden p-2 rounded-md text-charcoal ml-1"
                onClick={() => setMenuOpen(!menuOpen)}
                aria-label="Toggle menu"
              >
