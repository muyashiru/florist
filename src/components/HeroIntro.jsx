      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 border border-sand hover:border-rose-brand text-charcoal hover:text-rose-brand font-medium px-8 py-3.5 rounded-full transition-all duration-300"
          >
